...
- [`textures`, `sounds`, `media`, `models`, `locale`](#textures-sounds-media-models-locale)
  - [glTF](#gltf)
- [Example](#example)
- [Aliases for non-V6 mapgens](#aliases-for-non-v6-mapgens)
  - [Essential aliases](#essential-aliases)
  - [Optional aliases](#optional-aliases)
- [Aliases for Mapgen V6](#aliases-for-mapgen-v6)
  - [Essential](#essential)
  - [Optional](#optional)
- [Setting the node used in Mapgen Singlenode](#setting-the-node-used-in-mapgen-singlenode)
...
- [Advanced texture modifiers](#advanced-texture-modifiers)
  - [Crack](#crack)
  - [`[combine:<w>x<h>:<x1>,<y1>=<file1>:<x2>,<y2>=<file2>:...`](#combinewxhx1y1file1x2y2file2)
  - [`[resize:<w>x<h>`](#resizewxh)
  - [`[opacity:<r>`](#opacityr)
  - [`[invert:<mode>`](#invertmode)
  - [`[brighten`](#brighten)
  - [`[noalpha`](#noalpha)
  - [`[makealpha:<r>,<g>,<b>`](#makealphargb)
  - [`[transform<t>`](#transformt)
  - [`[inventorycube{<top>{<left>{<right>`](#inventorycubetopleftright)
  - [`[fill:<w>x<h>:<x>,<y>:<color>`](#fillwxhxycolor)
  - [`[lowpart:<percent>:<file>`](#lowpartpercentfile)
  - [`[verticalframe:<t>:<n>`](#verticalframetn)
  - [`[mask:<file>`](#maskfile)
  - [`[sheet:<w>x<h>:<x>,<y>`](#sheetwxhxy)
  - [`[colorize:<color>:<ratio>`](#colorizecolorratio)
  - [`[colorizehsl:<hue>:<saturation>:<lightness>`](#colorizehslhuesaturationlightness)
  - [`[multiply:<color>`](#multiplycolor)
  - [`[screen:<color>`](#screencolor)
  - [`[hsl:<hue>:<saturation>:<lightness>`](#hslhuesaturationlightness)
  - [`[contrast:<contrast>:<brightness>`](#contrastcontrastbrightness)
  - [`[overlay:<file>`](#overlayfile)
  - [`[hardlight:<file>`](#hardlightfile)
  - [`[png:<base64>`](#pngbase64)
- [Static coloring](#static-coloring)
  - [Global color](#global-color)
  - [Tile color](#tile-color)
- [Palettes](#palettes)
  - [Palette indexing](#palette-indexing)
  - [Using palettes with items](#using-palettes-with-items)
  - [Linking palettes with nodes](#linking-palettes-with-nodes)
- [Conversion between nodes in the inventory and on the map](#conversion-between-nodes-in-the-inventory-and-on-the-map)
- [Colored items in craft recipes](#colored-items-in-craft-recipes)
- [Orientation of axes](#orientation-of-axes)
- [Node coordinates](#node-coordinates)
- [Mapblock coordinates](#mapblock-coordinates)
  - [Converting node position to the containing blockpos](#converting-node-position-to-the-containing-blockpos)
  - [Converting blockpos to min/max node positions](#converting-blockpos-to-minmax-node-positions)
- [`image`](#image)
- [`text`](#text)
- [`statbar`](#statbar)
- [`inventory`](#inventory)
...
- [`ItemStack`](#itemstack)
- [Node and item groups](#node-and-item-groups)
- [Node-only groups](#node-only-groups)
- [Tool-only groups](#tool-only-groups)
- [`ObjectRef` armor groups](#objectref-armor-groups)
- [Full punch interval `full_punch_interval`](#full-punch-interval-full_punch_interval)
- [Maximum drop level `max_drop_level`](#maximum-drop-level-max_drop_level)
- [Uses `uses` (tools only)](#uses-uses-tools-only)
- [Maximum level `maxlevel`](#maximum-level-maxlevel)
- [Digging times `times`](#digging-times-times)
...
- [`formspec_version[<version>]`](#formspec_versionversion)
- [`size[<W>,<H>,<fixed_size>]`](#sizewhfixed_size)
- [`position[<X>,<Y>]`](#positionxy)
- [`anchor[<X>,<Y>]`](#anchorxy)
- [`padding[<X>,<Y>]`](#paddingxy)
- [`no_prepend[]`](#no_prepend)
- [`real_coordinates[<bool>]`](#real_coordinatesbool)
- [`container[<X>,<Y>]`](#containerxy)
- [`container_end[]`](#container_end)
- [`scroll_container[<X>,<Y>;<W>,<H>;<scrollbar name>;<orientation>;<scroll factor>]`](#scroll_containerxywhscrollbar-nameorientationscroll-factor)
- [`scroll_container_end[]`](#scroll_container_end)
- [`list[<inventory location>;<list name>;<X>,<Y>;<W>,<H>;<starting item index>]`](#listinventory-locationlist-namexywhstarting-item-index)
- [`listring[<inventory location>;<list name>]`](#listringinventory-locationlist-name)
- [`listring[]`](#listring)
- [`listcolors[<slot_bg_normal>;<slot_bg_hover>]`](#listcolorsslot_bg_normalslot_bg_hover)
- [`listcolors[<slot_bg_normal>;<slot_bg_hover>;<slot_border>]`](#listcolorsslot_bg_normalslot_bg_hoverslot_border)
- [`listcolors[<slot_bg_normal>;<slot_bg_hover>;<slot_border>;<tooltip_bgcolor>;<tooltip_fontcolor>]`](#listcolorsslot_bg_normalslot_bg_hoverslot_bordertooltip_bgcolortooltip_fontcolor)
- [`tooltip[<gui_element_name>;<tooltip_text>;<bgcolor>;<fontcolor>]`](#tooltipgui_element_nametooltip_textbgcolorfontcolor)
- [`tooltip[<X>,<Y>;<W>,<H>;<tooltip_text>;<bgcolor>;<fontcolor>]`](#tooltipxywhtooltip_textbgcolorfontcolor)
- [`image[<X>,<Y>;<W>,<H>;<texture name>;<middle>]`](#imagexywhtexture-namemiddle)
- [`animated_image[<X>,<Y>;<W>,<H>;<name>;<texture name>;<frame count>;<frame duration>;<frame start>;<middle>]`](#animated_imagexywhnametexture-nameframe-countframe-durationframe-startmiddle)
- [`model[<X>,<Y>;<W>,<H>;<name>;<mesh>;<textures>;<rotation>;<continuous>;<mouse control>;<frame loop range>;<animation speed>]`](#modelxywhnamemeshtexturesrotationcontinuousmouse-controlframe-loop-rangeanimation-speed)
- [`item_image[<X>,<Y>;<W>,<H>;<item name>]`](#item_imagexywhitem-name)
- [`bgcolor[<bgcolor>;<fullscreen>;<fbgcolor>]`](#bgcolorbgcolorfullscreenfbgcolor)
- [`background[<X>,<Y>;<W>,<H>;<texture name>]`](#backgroundxywhtexture-name)
- [`background[<X>,<Y>;<W>,<H>;<texture name>;<auto_clip>]`](#backgroundxywhtexture-nameauto_clip)
- [`background9[<X>,<Y>;<W>,<H>;<texture name>;<auto_clip>;<middle>]`](#background9xywhtexture-nameauto_clipmiddle)
- [`pwdfield[<X>,<Y>;<W>,<H>;<name>;<label>]`](#pwdfieldxywhnamelabel)
- [`field[<X>,<Y>;<W>,<H>;<name>;<label>;<default>]`](#fieldxywhnamelabeldefault)
- [`field[<name>;<label>;<default>]`](#fieldnamelabeldefault)
- [`field_enter_after_edit[<name>;<enter_after_edit>]`](#field_enter_after_editnameenter_after_edit)
- [`field_close_on_enter[<name>;<close_on_enter>]`](#field_close_on_enternameclose_on_enter)
- [`textarea[<X>,<Y>;<W>,<H>;<name>;<label>;<default>]`](#textareaxywhnamelabeldefault)
- [`label[<X>,<Y>;<label>]`](#labelxylabel)
- [`hypertext[<X>,<Y>;<W>,<H>;<name>;<text>]`](#hypertextxywhnametext)
- [`vertlabel[<X>,<Y>;<label>]`](#vertlabelxylabel)
- [`button[<X>,<Y>;<W>,<H>;<name>;<label>]`](#buttonxywhnamelabel)
- [`button_url[<X>,<Y>;<W>,<H>;<name>;<label>;<url>]`](#button_urlxywhnamelabelurl)
- [`image_button[<X>,<Y>;<W>,<H>;<texture name>;<name>;<label>]`](#image_buttonxywhtexture-namenamelabel)
- [`image_button[<X>,<Y>;<W>,<H>;<texture name>;<name>;<label>;<noclip>;<drawborder>;<pressed texture name>]`](#image_buttonxywhtexture-namenamelabelnoclipdrawborderpressed-texture-name)
- [`item_image_button[<X>,<Y>;<W>,<H>;<item name>;<name>;<label>]`](#item_image_buttonxywhitem-namenamelabel)
- [`button_exit[<X>,<Y>;<W>,<H>;<name>;<label>]`](#button_exitxywhnamelabel)
- [`button_url_exit[<X>,<Y>;<W>,<H>;<name>;<label>;<url>]`](#button_url_exitxywhnamelabelurl)
- [`image_button_exit[<X>,<Y>;<W>,<H>;<texture name>;<name>;<label>]`](#image_button_exitxywhtexture-namenamelabel)
- [`textlist[<X>,<Y>;<W>,<H>;<name>;<listelem 1>,<listelem 2>,...,<listelem n>]`](#textlistxywhnamelistelem-1listelem-2listelem-n)
- [`textlist[<X>,<Y>;<W>,<H>;<name>;<listelem 1>,<listelem 2>,...,<listelem n>;<selected idx>;<transparent>]`](#textlistxywhnamelistelem-1listelem-2listelem-nselected-idxtransparent)
- [`tabheader[<X>,<Y>;<name>;<caption 1>,<caption 2>,...,<caption n>;<current_tab>;<transparent>;<draw_border>]`](#tabheaderxynamecaption-1caption-2caption-ncurrent_tabtransparentdraw_border)
- [`tabheader[<X>,<Y>;<H>;<name>;<caption 1>,<caption 2>,...,<caption n>;<current_tab>;<transparent>;<draw_border>]`](#tabheaderxyhnamecaption-1caption-2caption-ncurrent_tabtransparentdraw_border)
- [`tabheader[<X>,<Y>;<W>,<H>;<name>;<caption 1>,<caption 2>,...,<caption n>;<current_tab>;<transparent>;<draw_border>]`](#tabheaderxywhnamecaption-1caption-2caption-ncurrent_tabtransparentdraw_border)
- [`box[<X>,<Y>;<W>,<H>;<color>]`](#boxxywhcolor)
- [`dropdown[<X>,<Y>;<W>;<name>;<item 1>,<item 2>, ...,<item n>;<selected idx>;<index event>]`](#dropdownxywnameitem-1item-2-item-nselected-idxindex-event)
- [`dropdown[<X>,<Y>;<W>,<H>;<name>;<item 1>,<item 2>, ...,<item n>;<selected idx>;<index event>]`](#dropdownxywhnameitem-1item-2-item-nselected-idxindex-event)
- [`checkbox[<X>,<Y>;<name>;<label>;<selected>]`](#checkboxxynamelabelselected)
- [`scrollbar[<X>,<Y>;<W>,<H>;<orientation>;<name>;<value>]`](#scrollbarxywhorientationnamevalue)
- [`scrollbaroptions[opt1;opt2;...]`](#scrollbaroptionsopt1opt2)
- [`table[<X>,<Y>;<W>,<H>;<name>;<cell 1>,<cell 2>,...,<cell n>;<selected idx>]`](#tablexywhnamecell-1cell-2cell-nselected-idx)
- [`tableoptions[<opt 1>;<opt 2>;...]`](#tableoptionsopt-1opt-2)
- [`tablecolumns[<type 1>,<opt 1a>,<opt 1b>,...;<type 2>,<opt 2a>,<opt 2b>;...]`](#tablecolumnstype-1opt-1aopt-1btype-2opt-2aopt-2b)
- [`style[<selector 1>,<selector 2>,...;<prop1>;<prop2>;...]`](#styleselector-1selector-2prop1prop2)
- [`style_type[<selector 1>,<selector 2>,...;<prop1>;<prop2>;...]`](#style_typeselector-1selector-2prop1prop2)
- [`set_focus[<name>;<force>]`](#set_focusnameforce)
...
- [Games and Modpacks](#games-and-modpacks)
- [`offset`](#offset)
- [`scale`](#scale)
- [`spread`](#spread)
- [`seed`](#seed)
...
- [Notes](#notes)
- [Methods](#methods)
- [Y stride and z stride of a flat array](#y-stride-and-z-stride-of-a-flat-array)
...
- [List of APIs exclusive to the mapgen env](#list-of-apis-exclusive-to-the-mapgen-env)
- [List of APIs available in the mapgen env](#list-of-apis-available-in-the-mapgen-env)
- [Registered definition tables](#registered-definition-tables)
...
- [Methods](#methods-7)
- [Methods](#methods-8)
- [Advice on handling `ObjectRefs`](#advice-on-handling-objectrefs)
